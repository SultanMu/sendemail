...
CORS_ALLOWED_ORIGINS = [
    "https://6ed162ac-9da7-45c5-89f5-3f39365ed118-00-2cxn4kbi86ete.janeway.replit.dev:3000",
    "http://localhost:3000",
    "http://127.0.0.1:3000",
]
...
# Static files configuration for serving React build
STATIC_URL = '/static/'
STATICFILES_DIRS = [
...
# Template configuration for serving React index.html
TEMPLATES = [
    {
