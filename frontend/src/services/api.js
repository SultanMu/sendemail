...
// Use the correct backend URL - port 5000 maps to port 80 externally
const API_BASE_URL = process.env.REACT_APP_API_URL || 'https://6ed162ac-9da7-45c5-89f5-3f39365ed118-00-2cxn4kbi86ete.janeway.replit.dev/api';
